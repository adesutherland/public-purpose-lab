...
Programme documents explain what Public Purpose Lab is establishing, why it
matters, the outcomes it seeks and how the work advances. They remain
business-facing and enduring; exact implementation choices belong in the
architecture and delivery material.

## Current programme set

- [Roadmap](roadmap.md) - the agreed business and capability direction,
  including the Discovery and Improvement Service, Service Evidence Workbench,
...
- [Demonstrator briefs](../scenarios/README.md) - the scenarios through which
  the programme proves value and produces evidence.

## Programme-document convention

The programme set may grow to include partnership and participation
...
[demonstrators](../scenarios/README.md). Evidence and limitations should flow
back into both the roadmap and the Architecture Portal blueprint.
