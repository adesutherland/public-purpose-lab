...
| Workbench shell | `http://[::1]:18082/workbench/` | Register the second presentation role and demonstrate the common visual surface; asset, RAG, workflow and reporting capabilities are not implemented.                 |
